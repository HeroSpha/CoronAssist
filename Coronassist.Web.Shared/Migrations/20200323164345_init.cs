        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LowUpperBound = table.Column<double>(nullable: false),
                    MidUpperBound = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    AccountBookId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AccountSurveyId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SurveyId = table.Column<int>(nullable: false),
                    Risk = table.Column<double>(nullable: false),
                    SurveyDate = table.Column<DateTime>(nullable: false),
                    UserSurveyStatus = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountSurveys", x => x.AccountSurveyId);
                    table.ForeignKey(
                        name: "FK_AccountSurveys_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionAnswers", x => x.SurveyAnswerId);
                    table.ForeignKey(
                        name: "FK_QuestionAnswers_AccountSurveys_AccountSurveyId",
                        column: x => x.AccountSurveyId,
                        principalTable: "AccountSurveys",
                        principalColumn: "AccountSurveyId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightDetails_QuestionAnswers_SurveyAnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightDetails_SurveyAnswerId",
                table: "FlightDetails",
                column: "SurveyAnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionAnswers_AccountSurveyId",
